# utils/training/generate_scalers.py

import pandas as pd
import joblib
from sklearn.preprocessing import StandardScaler, MinMaxScaler
from utils.file_utils import save_csv, save_json, load_csv
import os
...
# 6. CSV 저장
save_csv(X_scaled_df.to_dict(orient="records"), OUTPUT_PATH)
print(f"✅ 학습용 training_data.csv 저장 완료 → {OUTPUT_PATH}")
